...
const stripe = Stripe('pk_test_51I59kfFPKVUdiMIHQQ0jvz5gRtpOYFxNIsBfsCthH8cw8fqeuPMr57RAkYaQu8V9jWOvYgWupemKWLvylGh3JYvx00r6jIt7DL');
    ...
    buyPlansButtons[i].addEventListener("click" , async function(){
        try{
            if(allLis.length < 6){
                ...
                let session =  await axios.post("https://foodzoned-app.herokuapp.com/api/booking/createPaymentSession" , {planId : planId });
